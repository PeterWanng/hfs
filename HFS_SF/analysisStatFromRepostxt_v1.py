# -*- coding=utf-8 -*-
"after 2013-12-14, the data format of repost and comments are changed to csv, so the 'txt2list' function should be replaced by 'gt.csv2list_new(fp,passmetarowcnt=1)' in line 261 maybe , please search it"
...
#     wriTimePercnt()
    ...
    cocfolder = 'G:\\HFS\\WeiboData\\HFSWeiboNoCOC\\'
    gmlfolder = 'G:\\HFS\\WeiboData\\HFSWeiboGMLNew\\'
