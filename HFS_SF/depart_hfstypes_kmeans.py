...
#             pass
        ...
        i+=1
        try:
            print feature_file.split('.')[-1]#len(group),len(casefeature_list)
...
if __name__=='__main__':
    filefolder = r'G:\HFS\WeiboData\HFSWeiboStatNet\StatNet\statcore'#r'G:\HFS\WeiboData\Statistics\HFSWeibo_MultiDiGraph\network\avguser20'#clear
