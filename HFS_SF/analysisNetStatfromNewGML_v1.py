...
def analyze_one(cocfilename, coc_folder,gmlfolder,percentlist=[1],timeseriesfile = r'G:\HFS\WeiboData\HFSWeiboStatNet\Stat\TimeSeries.txt',periodcnt=1,graphAll = None):
    ...
    for percent in percentlist:
        ...
        for timep in timelistPeriodNow:
            ...
            netAttribute_all = analysisNet(g)
...
if __name__ == '__main__':
    print 'All acting'
    time.clock()
    netStatpath = 'G:\\HFS\\WeiboData\\HFSWeiboStatNet\\StatNet\\test\\'
    cocfolder = 'G:\\HFS\\WeiboData\\HFSWeiboNoCOC\\test\\'#'G:\\HFS\\WeiboData\\HFSWeiboCOC\\'
    gmlfolder = 'G:\\HFS\\WeiboData\\HFSWeiboGMLNew\\test\\'#"G:\\HFS\\WeiboData\\HFSWeibo\\testNew\\GML\\"#
